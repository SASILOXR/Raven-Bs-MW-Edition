...
loom {
  ...
  mixin { defaultRefmapName.set("mixins.raven.refmap.json") }
}
...
tasks.processResources {
  ...
  filesMatching(listOf("mcmod.info", "mixins.raven.json")) { expand(inputs.properties) }
...
tasks.shadowJar {
  ...
  doLast { configurations.forEach { println("Copying dependencies into mod: ${it.files}") } }
